...
app.directive("myRadioButtonField", function() { 
	return { 
		restrict: "E", 
		//transclude: true,
		scope: { 
		...
		controller :function MyRadioButtonFieldController($scope, $mdDialog, variableList) {
			$scope.visibility = false;
			$scope.new_variables = [];
							
			$scope.showRadioField = function () {	
		...
		templateUrl: "components/container/element/form/field/radio_button/radioButtonField.html"			
	}; 
});